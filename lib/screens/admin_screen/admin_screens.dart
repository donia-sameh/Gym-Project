...
import 'package:phone_auth/screens/admin_screen/popups/createClass.dart';
import 'package:phone_auth/screens/admin_screen/popups/Createcoach.dart';
import 'package:phone_auth/screens/admin_screen/popups/deleteClass.dart';
import 'package:phone_auth/providers/userprovider.dart';
...
import 'package:phone_auth/shared/customWidgets/custom_app_bar.dart';
      ...
      body: SafeArea(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          CustomButtom(
            ...
            width: 350,
            pressed: (() {
              showDialog(context: context, builder: (context) => CreateClass());
            }),
          ),
          SizedBox(height: 20),
          CustomButtom(
